 ...
 * Initiates Stripe Connect OAuth flow (Standard, read_only scope).
 * Requires env: STRIPE_CLIENT_ID
 */
...
export async function GET(req: NextRequest) {
  ...
  if (!clientId) {
    return NextResponse.redirect(new URL('/integrations?error=stripe_not_configured', req.url));
  }
