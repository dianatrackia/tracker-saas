        ...
        <div className="px-5 py-4" style={{ borderBottom: '1px solid rgba(255,255,255,0.07)' }}>
          <div className="flex items-center gap-3">
            ...
            <div className="leading-none">
              <span className="font-extrabold text-white text-base tracking-wide block">DIANA</span>
              <span className="text-xs font-semibold tracking-widest uppercase" style={{ color: '#E53535' }}>Tracking</span>
            </div>
          </div>
          {workspace && (
            <div
            ...
            >
              <p className="text-xs mb-0.5" style={{ color: 'rgba(255,255,255,0.4)' }}>Workspace</p>
